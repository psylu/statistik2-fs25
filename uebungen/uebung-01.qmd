...
- [Datensatz 1](../data/stroop_data_sub-01.csv)
- [Datensatz 2](../data/stroop_data_sub-01.xlsx)
...
b. Lesen Sie den Datensatz `stroop_data_sub-01.csv` ein aus dem `data`-Ordner ein.
...
Führen Sie dieselben Schritte für `stroop_data_sub-01.xlsx` aus.

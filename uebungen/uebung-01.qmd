...
b. Identifizieren Sie die 3 Bausteine eines Notebooks: Header, Textfeld und Codefeld mit folgenden Fragen:
    ...
    - Für was eignet sich der Baustein besonders und für nicht?
...
b. Lesen Sie den Datensatz `stroop_data_sub-01.csv` ein aus dem `data`-Ordner ein. Gehen Sie dabei schrittweise vor:
...
e. Falls nötig: Öffnen Sie ihr _IntroNotebook_ wieder und führen Sie Ihren Code mit `Run all` aus.
Jetzt sollten Sie zum Schluss zwei Grafiken haben.

f. Zeigen Sie einander die Grafiken und diskutieren Vor- und Nachteile der Darstellungsformen.

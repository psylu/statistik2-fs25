...
- Lesen Sie den Studienbeschrieb.

- Lesen Sie dann den Datensatz `dataset_vacation.csv` ein und machen Sie sich mit ihm vertraut. 

Gehen Sie für jede Fragestellung wie folgt vor:
...
__Lesen Sie die Daten ein.__

- Finden Sie alle nötigen Variablen?
- Welche Variablen, Variablentypen, etc. sind vorhanden?
...
## Aufgabe 13.1: Gesundheit und Jahreszeiten

> __Wie unterscheiden sich die Gesundheitswerte von Personen in _high-stress_-Jobs von Personen in _low-stress_-Jobs in der Zeit vor den Ferien?__

__a. Datenanalyse festlegen__
...
> __Wie sagen Schlafqualität und Energielevel während den Ferien den Gesundheitswert vorher?__
...
> __Welchen Effekt hat die Jahreszeit der Ferien auf das Wohlbefinden nach den Ferien (Energielevel und Schlaf)?__

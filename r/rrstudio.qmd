...
Ein neuer Codechunk wird eingefügt mit der Tastenkombination {{< kbd Ctrl >}} + {{< kbd Alt >}} +{{< kbd I >}} / {{< kbd Option >}} +{{< kbd Command >}} + {{< kbd I >}} oder unter `Code` > `Insert Chunk`.^[Der Codechunk kann auch selber erstellt werden, indem die Backticks etc. eingegeben werden, aber das ist eher aufwändig.]
...
Weiter können auch Bilder eingefügt werden und der Text kann mit Kapiteln, __fett__/_kursiv_ Schrift, etc. strukturiert werden.

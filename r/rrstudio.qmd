...
Ein neuer Codechunk wird eingefügt mit der Tastenkombination {{< kbd Ctrl Alt I >}} / {{< kbd Option Command I >}} oder unter `Code` > `Insert Chunk`.^[Der Codechunk kann auch selber erstellt werden, indem die Backticks etc. eingegeben werden, aber das ist eher aufwändig.]

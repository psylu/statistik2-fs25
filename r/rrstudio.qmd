...
- __Arbeitsverzeichnis__, __Plots__, __Packages__, _Help__, ...: Hier finden Sie diverse hilfreiche Informationen wie z.B. die Ordnerstruktur mit der Sie aktuell arbeiten (_working directory_), die Anzeige von Plots, welche _Packages_ installiert und geladen sind, Hilfe zu den einzelnen Funktionen, u.v.m.
...
- Code anwählen und {{< kbd Ctrl-Enter >}} eingeben
...
In einem _RNotebook_ ist Text grundsätzlich normaler Text. Code kann eingefügt werden, indem man ein Code-Feld (Chunk) einfügt.
Ein neuer Codechunk wird eingefügt mit der Tastenkombination {{< kbd Ctrl-Alt-I >}} oder unter `Code` > `Insert Chunk`.^[Der Codechunk kann auch selber erstellt werden, indem die Backticks etc. eingegeben werden, aber das ist eher aufwändig.]
...
Weiter können auch Bilder eingefügt werden und der Text kann mit Kapiteln, fett/kursiv Schrift, etc. strukturiert werden.
...
## Erstellen und Verwenden von _RNotebooks_

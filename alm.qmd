...
Mit einem allgemeinen linearen Modell (ALM) können mittels Regression Merkmalsunterschiede in einer abhängigen metrischen Variable vorhergesagt werden. Die in den vorherigen Kapitel beschriebenen Analysemodelle gehören alle zu den allgemeinen linearen Modellen.

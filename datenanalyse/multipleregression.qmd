...
Man kann sich dies vorstellen, wie 2 Geraden, die durch eine 3-dimensionale Punktewolke gelegt werden. 
Das Verbinden der beiden Geraden ergibt eine Ebene.
Durch das Drehen des untenstehenden Plots kann erkannt werden, dass die Seite der Ebene für $x_1$ und $x_2$ eine Gerade bildet.
...
Die interaktive Grafik zeigt, wie die beiden Regressionsgeraden zusammen eine Regressionsebene bilden. 
...
<!-- Die Signifikanz der Regressionskoeffizienten -->

<!-- beiden Variablen signifikant zusammenhängen, kann die Teststatistik berechnet werden. -->

...
Für den _t_-Test werden die Daten hier in einem `long`-Format benötigt. 
...
> Personen mit der Diagnose _X_ unterscheiden sich nicht in ihrer Schmerzempfindlichkeit von Personen ohne Diagnose _X_, _t_(40)=-0.13,) _p_ = .64).
...
Eine Teststärke (Power) von 0.94 bedeutet, dass die Wahrscheinlichkeit 94 % beträgt, einen tatsächlich vorhandenen Effekt mit einer Effektstärke von 0.8 zu entdecken.
